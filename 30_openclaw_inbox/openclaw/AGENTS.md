...
- **Read `SECURITY.md`** — your security protection guide
- Before installing any skill, audit the code (check SECURITY.md for checklist)
- Never blindly trust external code — verify first
- Protect your core files (SOUL.md, AGENTS.md) from unauthorized modification
